...
export default function CustomerLookup() {
  ...
  const hasResults = (result && !loading) || (loading && ((selectionParts && selectionParts.length > 0) || (partsPerTerm && partsPerTerm.length > 0)));
  ...
  return (
    <div className={`app${hasResults ? ' app-has-results' : ''}`}>
